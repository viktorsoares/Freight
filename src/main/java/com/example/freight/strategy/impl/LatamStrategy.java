...
public class LatamStrategy implements FreightStrategy, DeliveryTimeStrategy {
    ...
    public BigDecimal calculate(FreightRequest request, double distanceKm) {
        BigDecimal base = request.deliveryMode() == DeliveryMode.FAST
                ? BigDecimal.valueOf(55.0) // Expresso
                : BigDecimal.valueOf(35.0); // Standard
        ...
        base = base.add(BigDecimal.valueOf(chargedWeight * 3.0));

        BigDecimal distanceCost = BigDecimal.valueOf((distanceKm / 100.0) * 0.45);
